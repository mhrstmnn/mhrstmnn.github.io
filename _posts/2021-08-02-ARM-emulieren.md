...
- Optional: `sudo apt-get install build-essential` installieren

## QEMU user mode

- mit `sudo apt install qemu-user` installieren
- mit `qemu-arm -L /usr/arm-linux-gnueabihf/ EXEC` ausführen
- <a href="https://yurovsky.github.io/2016/12/14/qemu-user-mode.html" target="blank">"Using qemu user mode to run cross-compiled binaries"</a>
